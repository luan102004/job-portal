      ...
      <div className='bg-white text-black rounded-lg w-full'>
        <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400  rounded-x1'>
          ...
          <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
            ...
            <p className='m-1 text-gray-600'>Poster {moment(JobData.date).fromNow() }</p>
          </div>

        </div>

    <div className='flex flex-cpl lg:lex-row justify-between items-start'>
      <div className='w-full lg:w-2/3'>
        <h2 className='font-bold text-2x1 mb-4'>Job description</h2>
